...
public class DefaultPatternEdit extends RoboActivity {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case ACTIVITY_PATTERN_EDIT:
			...
			{
				user_settings.defaultPattern(data.getLongArrayExtra(VibratePatternEdit.EXTRA_KEY_PATTERN));
			}
			finish();
			break;
		}
	...
	private void editPattern() {
		...
		i.putExtra(VibratePatternEdit.EXTRA_KEY_PATTERN, user_settings.defaultPattern());
