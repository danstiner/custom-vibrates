...
public class SyncEntities extends RoboAsyncTask<Boolean> {
	...
	@Inject
	public SyncEntities(IEntityManager entity_manager, IIdentifierManager identifier_manager)
	{
    ...
    protected void onException(Exception e) { 
        ...
        //Toast.makeText(SearchActivity.this, failureMessage, Toast.LENGTH_SHORT).show(); 
    } 
