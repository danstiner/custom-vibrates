...
public class BackupUtil {
	...
	public boolean Backup() {
		...
		try {
			...
			FileWriter f = new FileWriter(new File(dir, BACKUP_FILE_NAME),
					false);
	...
	private static String formatEntityOut(String kind, Uri contactUri,
			long[] pattern) {
		StringBuilder sb = new StringBuilder();

		if (kind != null)
			sb.append(kind.replaceAll(LINE_END, " ").replaceAll(
					FIELD_SEPARATOR, ""));
		sb.append(FIELD_SEPARATOR);

		if (contactUri != null)
			sb.append(contactUri.toString().replaceAll(LINE_END, " ")
