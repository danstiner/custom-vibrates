...
public class MorseCodePattern {
	...
	public static final long[] PERIOD = { DIT, g, DAH, g, DIT, g, DAH, g, DIT,
			g, DAH };
	public static final long[] COMMA = { DAH, g, DAH, g, DIT, g, DIT, g, DAH,
			g, DAH };
	public static final long[] QUESTION_MARK = { DIT, g, DIT, g, DAH, g, DAH,
			g, DIT, g, DIT };
	public static final long[] APOSTROPHE = { DIT, g, DAH, g, DAH, g, DAH, g,
			DIT };
	public static final long[] EXCLAMATION_MARK = { DAH, g, DIT, g, DAH, g,
			DIT, g, DAH, g, DAH };
	public static final long[] SLASH = { DAH, g, DIT, g, DIT, g, DAH, g, DIT };
	public static final long[] PAREN_OPEN = { DAH, g, DIT, g, DAH, g, DAH, g,
			DIT };
	public static final long[] PAREN_CLOSE = { DAH, g, DIT, g, DAH, g, DAH, g,
			DIT, g, DAH };
	public static final long[] AMPERSTAND = { DIT, g, DAH, g, DIT, g, DIT, g,
			DIT };
	public static final long[] COLON = { DAH, g, DAH, g, DAH, g, DIT, g, DIT,
			g, DIT };
	public static final long[] SEMICOLON = { DAH, g, DIT, g, DAH, g, DIT, g,
			DAH, g, DIT };
	public static final long[] EQUALS_SIGN = { DAH, g, DIT, g, DIT, g, DIT, g,
			DAH };
	public static final long[] PLUS = { DIT, g, DAH, g, DIT, g, DAH, g, DIT };
	public static final long[] MINUS = { DAH, g, DIT, g, DIT, g, DIT, g, DIT,
			g, DAH };
	public static final long[] UNDERSCORE = { DIT, g, DIT, g, DAH, g, DAH, g,
			DIT, g, DAH };
	public static final long[] QUOTE_MARK = { DIT, g, DAH, g, DIT, g, DIT, g,
			DAH, g, DIT };
	public static final long[] DOLLAR_SIGN = { DIT, g, DIT, g, DIT, g, DAH, g,
			DIT, g, DIT, g, DAH };
	public static final long[] AT_SIGN = { DIT, g, DAH, g, DAH, g, DIT, g, DAH,
			g, DIT };

	public static final long[] A_UMLAUT = { DIT, g, DAH, g, DIT, g, DAH };
	public static final long[] A_GRAVE = { DIT, g, DAH, g, DAH, g, DIT, g, DAH };
	public static final long[] C_CEDILLA = { DAH, g, DIT, g, DAH, g, DIT, g,
			DIT };
	public static final long[] CH = { DAH, g, DAH, g, DAH, g, DAH };
	public static final long[] ETH = { DIT, g, DIT, g, DAH, g, DAH, g, DIT };
	public static final long[] S_MARK = { DIT, g, DIT, g, DIT, g, DAH, g, DIT,
			g, DIT, g, DIT };
