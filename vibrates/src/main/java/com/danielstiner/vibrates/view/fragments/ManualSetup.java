...
public class ManualSetup extends RoboActivity {
	...
	@InjectView(R.id.setup_manual_openaccessiblity)
	private Button buttonOpenAccessibility;

	@InjectView(R.id.setup_manual_defaultpattern_editbox)
	private LinearLayout defaultPatternEditBox;

	@InjectView(R.id.setup_manual_defaultpattern)
	private PatternView defaultPatternView;

	@InjectView(R.id.setup_manual_addcontact)
	private Button buttonAddContact;

	@InjectView(R.id.setup_manual_complete)
	...
	@Inject
	private PatternEditManager defaultPatternEditManager;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		startMainScreenIntent = new Intent(this, ListEntities.class);
	...
	private void setupDefaultPatternEdit() {
		...
		defaultPatternEditManager.setWatcher(new Runnable() {
			...
			public void run() {
				...
				// and save it
				user_settings.defaultPattern(defaultPatternEditManager
						.getPattern());
