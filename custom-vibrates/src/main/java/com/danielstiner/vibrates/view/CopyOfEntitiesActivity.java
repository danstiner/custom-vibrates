...
public class CopyOfEntitiesActivity extends RoboFragmentActivity implements
		ListEntitiesFragment.ContainerActivityInterface {

	private static final String CLASSNAME = Vibrates.NS + "view.EntitiesActivity";
	...
	private OnMenuItemClickListener mOnMenuAddEntityClick = new OnMenuItemClickListener() {
		...
		public boolean onMenuItemClick(MenuItem item) {
			...
			EntityAddActivity.show(mSelectedKind, CopyOfEntitiesActivity.this,
					CopyOfEntitiesActivity.ACTIVITY_RESULT_ADD);
	...
	public static void show(Context context) {
		Intent i = new Intent(context, CopyOfEntitiesActivity.class);
